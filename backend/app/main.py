...
logger = logging.getLogger("campaigniq")


@asynccontextmanager
async def lifespan(app: FastAPI):
    # Startup: Verify database and redis connection
    logger.info("Initializing CampaignIQ backend application...")
    try:
    ...
    logger.info("Shutting down CampaignIQ backend application...")
...
app = FastAPI(
    ...
    description="Grounded, personalized campaign outreach API",
    version="2.0.0",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc",
