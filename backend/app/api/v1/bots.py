...
async def create_bot(
    ...
    """Create a website knowledge source and queue its crawl job.
    ...
    def _dispatch():
        try:
            ...
            _logging.getLogger("campaigniq.bots").warning(
...
async def list_bots(
    ...
    """Return all websites owned by the authenticated user, ordered newest-first."""
...
async def delete_bot(
    ...
    All related crawl jobs, pages, documents, chunks, and brand settings are
    removed by the database's ON DELETE CASCADE rules.
