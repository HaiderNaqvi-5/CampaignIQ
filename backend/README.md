...
The backend is a FastAPI application for authentication, website intelligence,
HubSpot CRM synchronization, campaign generation, and email delivery.

## Main components

- `app/api/v1/`: versioned HTTP routes
- `app/models/`: SQLAlchemy models for users, websites, CRM data, knowledge,
  and campaigns
...
tenant isolation, ingestion, retrieval, CRM, and campaign coverage.
