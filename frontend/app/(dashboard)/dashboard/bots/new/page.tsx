    ...
    <div className="mx-auto max-w-6xl space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[#9EA3AA]">
          Give CampaignIQ a public website and it will build an
          isolated knowledge source for grounded campaign emails.
        </p>
      </div>
        ...
        <section className="rounded-2xl border border-[#C8CBD0]/10 bg-[#111418] p-6 sm:p-8">
          <div className="mb-7 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[#8C9299]">
                Start with the website you want CampaignIQ to learn.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-2 text-xs leading-5 text-[#5F656D]">
                Leave this blank and CampaignIQ will derive a name
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-[#8C9299]">
                    Every website gets its own bot-scoped
        ...
        <aside className="space-y-4">
          <div className="rounded-2xl border border-[#C8CBD0]/10 bg-[#111418] p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-[#8C9299]">
              CampaignIQ automatically processes the website and
              prepares it for grounded campaign generation.
            </p>
          </div>
          ...
          {[
            ...
            },
            {
              ...
              description:
                'Use retrieved facts and writing style in campaign emails.',
              icon: Bot,
            },
          ].map(
            ({
