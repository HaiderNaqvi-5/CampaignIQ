      ...
      <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[#8C9299]">
            Each website uses its own isolated knowledge base.
          </p>
        </div>
      ...
      {!loading && bots.length > 0 && (
        <div className="relative max-w-md">
          ...
          <input
            ...
            placeholder="Search websites by name, URL or status..."
      ...
      {!loading && !error && bots.length === 0 && (
        <section className="rounded-2xl border border-dashed border-[#C8CBD0]/15 bg-[#111418] px-6 py-20 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-[#8C9299]">
            Add your first website by entering its URL.
            CampaignIQ will crawl the website and build its isolated
            knowledge base.
          </p>
