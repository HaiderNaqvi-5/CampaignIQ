...
import { Bot, LayoutDashboard, LogOut, Loader2, Sparkles, Database, Settings, Users, Mail } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'Websites', href: '/dashboard/bots', icon: Bot },
  { label: 'Knowledge', href: '/dashboard/knowledge', icon: Database },
  { label: 'HubSpot', href: '/dashboard/hubspot', icon: Users },
