      ...
      <div className="rounded-2xl border border-[#2A2E34] bg-[#111418] p-8 shadow-2xl">
        <div className="mb-7">
          ...
          <h1 className="text-2xl font-bold text-[#F5F5F3]">
            Sign in to CampaignIQ
          </h1>

          <p className="mt-2 text-sm text-[#8C9299]">
            Access your websites, contacts and campaigns.
          </p>
        </div>
        ...
        {googleClientId && (
          <>
            <div className="my-5 flex items-center gap-3 text-xs text-[#6F757D]">
              <span className="h-px flex-1 bg-[#34383E]" />
              OR
              <span className="h-px flex-1 bg-[#34383E]" />
            </div>
